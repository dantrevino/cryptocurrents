...
## build unsigned native apk

* ensure ANDROID_HOME to your SDK root.  For me `export ANDROID_HOME=$HOME/Android/SDK`
* ensure $ANDROID_HOME/platform-tools and $ANDROID_HOME/tools are in your path.  `export PATH=$PATH:$ANDROID_HOME/platform-tools:$ANDROID_HOME:/tools`
* copy your main app file to 'index.android.js'. `cp {App.js,index.js,whatever.js} index.android.js`.  Or alternatively, modify the `--entry-file` path below
* "Eject" the rn app `npm run eject`
...
* Your apk will be located in 'android/app/build/outputs/apk'
